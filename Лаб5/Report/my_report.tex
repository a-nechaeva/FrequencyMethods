...
\hfill
\begin{minipage}[h!]{0.5\linewidth}
\center{\includegraphics[width=1\linewidth]{pic1/f_n_1000_5.png}} \\б)
\end{minipage}
\caption{ Графики восстановленной и исходной функции $\Pi(t)$ при a) $n=10000$, б) $n=1000$.}
\end{figure}
...
\hfill
\begin{minipage}[h!]{0.5\linewidth}
\center{\includegraphics[width=1\linewidth]{pic1/f_n_100_5.png}} \\б)
\end{minipage}
\vfill
\begin{minipage}[h!]{0.5\linewidth}
\center{\includegraphics[width=1\linewidth]{pic1/f_n_90_5.png}} \\в)
\end{minipage}
\hfill
\begin{minipage}[h!]{0.5\linewidth}
\center{\includegraphics[width=1\linewidth]{pic1/f_n_30_5.png}} \\г)
\end{minipage}
\caption{ Графики восстановленной и исходной функции $\Pi(t)$ при a) $n=200$, б) $n=100$, a) $n=90$, б) $n=30$.}
\end{figure}


\newpage

Сравнивая графики на рисунках 4, 5а-б, можно сделать вывод о том, что при уменьшении числа итераций в вычислении интегралов для нахождения Фурье-образа и последующего восстановления функции, сходство графиков исходной и восстановленной функций возрастает.\\
