...
f(t) = 
\begin{cases}
-\pi \, , \, t \in \left[-\pi , \, 0 \right),\\
\pi \, , \, t \in \left[0, \, \pi \right) 
\end{cases}
\end{equation}
...
\begin{equation}
a_0 =  \frac{2}{T} \int \limits_{h}^{h + T} f(t) dt = -\int \limits_{-\pi}^{0} 1 dt +  \int \limits_{0}^{\pi} 1 dt = - (0 - -\pi) + \pi = 0
\end{equation}


\begin{multline}
a_n = \frac{2}{T} \int \limits_{h}^{h + T} f(t) \cos (nt) dt =  \frac{1}{\pi}\int \limits_{-\pi}^{0} -\pi \cos (nt) dt +  \frac{1}{\pi}\int \limits_{0}^{\pi} \pi \cos (nt) dt = \\
= - \int \limits_{-\pi}^{0} \cos (nt) dt + \int \limits_{0}^{\pi} \cos (nt) dt = 0
\end{multline}

\begin{multline}
b_n = \frac{2}{T} \int \limits_{h}^{h + T} f(t) \sin (nt) dt =  \frac{1}{\pi}\int \limits_{-\pi}^{0}  -\pi  \sin (nt) dt  + \frac{1}{\pi}\int \limits_{0}^{\pi }  \pi  \sin (nt) dt = \\
= - \int \limits_{-\pi}^{0} \sin (nt) dt  + \int \limits_{0}^{\pi } \sin (nt) dt = 
\end{multline}
