...
\begin{equation}
a_0 =  \frac{2}{T} \int \limits_{h}^{h + T} f(t) dt =   \frac{1}{\pi} \int \limits_{-\pi}^{\pi} \sin^3(x) dt = 0
\end{equation}


\begin{multline}
a_n = \frac{2}{T} \int \limits_{h}^{h + T} f(t) \cos (nt) dt =  
\end{multline}

\begin{multline}
b_n = \frac{2}{T} \int \limits_{h}^{h + T} f(t) \sin (nt) dt = 
\end{multline}
