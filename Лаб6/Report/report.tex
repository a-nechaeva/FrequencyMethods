...
\end{figure}
\newpage
Пики, соответствующие периодичности на исходной картинке, находятся преимущественно в центре картинки нормализованного логарифма модуля Фурье-образа (белый цвет). После редактирования изображения на рисунке 2, восстановленное изображение представлено на рисунке 3. Видно, что полосы стали менее выделяющимися (но что-то пошло не так, поэтому этот результат будет исправляться).


\begin{figure}[h!]
\center{\includegraphics[width=1\linewidth]{pic/wrong.jpg}}
